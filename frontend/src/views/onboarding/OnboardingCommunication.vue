  ...
  <OnboardingLayout>
    <div class="mx-auto max-w-5xl">
      <div class="text-center">
        <h2 class="text-2xl font-bold text-slate-900">Connect Communication Tools</h2>
        <p class="mt-2 text-slate-600">
          Connect your messaging platforms to search conversations and channels
        </p>
      </div>
      ...
      <div v-else class="mt-12 grid gap-6 md:grid-cols-2">
        <IntegrationCard
          v-for="integration in communicationIntegrations"
...
onMounted(async () => {
  try {
    ...
    communicationIntegrations.value = integrations.value.communication || []
  } catch (error) {
